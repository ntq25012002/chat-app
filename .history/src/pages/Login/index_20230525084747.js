...
function Login() {
    ...
    return (
        <>
            <AuthForm onSubmit={handleLogin} loginForm={true} initialFormData={initialFormData} buttonText='Đăng nhập' title='Đăng nhập' link="/register" linkText='Đăng ký ngay nào' />
        </>
    );
}
