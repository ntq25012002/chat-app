    ...
    const validateForm = () => {
        ...
        if(props.registerForm) {
            ...
            if(formData.email.trim() == '' ) {
                ...
                isValid = false;
            } else if( isNaN(formData.email) && !emailRegex.test(formData.email)) {
            ...
            if(rePassword.trim() == '') {
                ...
                isValid = false;
            }else if(rePassword.trim() !== formData.password.trim()) {
        ...
        <div className={cx('wrapper')}>
            <div className={cx('content')} >
                ...
                <div className={cx('form-container')}>
                    ...
                    <p>Lỗi:</p>  {errors && JSON.stringify(errors)}
