...
import {faRightFromBracket, faComment, faUsers, faUser, faGear, faMagnifyingGlass, faUserPlus } from "@fortawesome/free-solid-svg-icons"
// import {} from "@fortawesome/free-regular-svg-icons";

import SideBarListChat from '~/layouts/components/SideBar/SideBarListChat';
            ...
            <div className={cx('content-scroll', 'list-chat')}>
                ...
                <div>
                    ...
                    <div className={cx('recent-chat')}>
                        <div className={cx('recent-chat-text')}>
                            Gần đây
                        </div>
