...
import {faRightFromBracket, faComment, faUsers, faUser, faGear, faMagnifyingGlass, faUserPlus, faUsersRay } from "@fortawesome/free-solid-svg-icons"
                ...
                <div className={cx('title')}>
                    ...
                    <div className={cx('add-friend')}>
                        ...
                        <div className={cx('icon-add-group')}>
                            <FontAwesomeIcon icon={faUsersRay} />
                        </div>
                    </div>
                </div>
                <div>
